...
function operadoresLogicos(num1, num2, num3) {
  ...
  //0 no es ni positivo ni negativo. Si alguno de los argumentos es 0, retornar "Error".r
  //Si no se cumplen ninguna de las condiciones anteriores, retornar false. r
