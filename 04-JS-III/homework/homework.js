...
function dePalabrasAFrase(palabras) {
    ...
    // Tu código:var array = ["esto", "es", "un","array"]

    let arrayConvert = palabras.toString()

    arrayWithOutSpace = arrayConvert.replace(/,/g, " ");
...
function numeroMasGrande(numeros) {
    ...
    // Tu código:
    let ordenados = numeros.sort(function (a, b) { return a - b })
...
function empiezaConNueve(n) {
    ...
    //Escribe tu código aquí
    letNumIntoArray = Array.from(String(n), Number);

    if (letNumIntoArray[0] === 9) {
        return true
    } else {
        return false;
    }
...
function mesesDelAño(array) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        if (element === "Enero" || element === "Marzo" || element === "Noviembre") {
            arrayExtrac.push(element)
        }

    }
    console.log(arrayExtrac)

    if (arrayExtrac.includes("Enero") === true &&
        arrayExtrac.includes("Marzo") === true &&
        arrayExtrac.includes("Noviembre") === true) {
        console.log(arrayExtrac);
        return arrayExtrac
...
function breakStatement(numero) {
    ...
    // Tu código:
    let arregloaRetornar = [];
    for (let i = 0; i < 10; i++) {
        numero = numero + 2
        arregloaRetornar.push(numero)
        if (numero === i) {
